        ...
        <div className="mt-24 grid sm:grid-cols-1 lg:grid-cols-3 gap-6 justify-center align-middle">
          <div className="card w-96 bg-[#1c222a]">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions mt-8">
                ...
                <a
                  href="https://github.com/Sharif-Miah/bistro-boss-clint-site"
                  target="_blank"
                >
                  <FaGithub className="text-white text-3xl mx-6" />
                </a>
                <a
                  href="https://github.com/Sharif-Miah/bistro-boss-server-site"
                  target="_blank"
                >
          ...
          <div className="card w-96 bg-[#1c222a]">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions mt-8">
                ...
                <a
                  href="https://github.com/Sharif-Miah/geniusCar-client-site"
                  target="_blank"
                >
                  <FaGithub className="text-white text-3xl mx-6" />
                </a>
                <a
                  href="https://github.com/Sharif-Miah/geniusCar-server-site"
                  target="_blank"
                >
                  <FaGithub className="text-white text-3xl" />
                </a>
          ...
          <div className="card w-96 bg-[#1c222a]">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions mt-8">
                <a
                  href="https://kaleidoscopic-sundae-e7a993.netlify.app/course"
                  target="_blank"
                >
                  <FaArrowUpRightFromSquare className="text-white text-3xl" />
                </a>
                <a
                  href="https://github.com/Sharif-Miah/Develop-skill-client-site-repo"
                  target="_blank"
                >
                  <FaGithub className="text-white text-3xl mx-6" />
                </a>
                <a
                  href="https://github.com/Sharif-Miah/Develop-skill-server-site-repo"
                  target="_blank"
                >
                  <FaGithub className="text-white text-3xl" />
                </a>
