        ...
        <div className="hero ">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className="sm:w-full lg:w-1/2">
              ...
              <h1 className="text-[60px] text-white font-bold">Sharif Miah</h1>
              <h4 className="text-[20px] font-bold text-[#f5b711] my-4 uppercase">
                I AM Web Developer
              </h4>
              <p className=" text-white text-[18px] mb-[36px] leading-10">
                From Dhaka, Bangladesh. I’m a Front End Web developer who is
                passionate about making websites. I am good at ReactJS. I love
